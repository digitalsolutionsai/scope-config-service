...
func (x *ListConfigTemplatesRequest) GetServiceName() string {
	if x != nil {
		return x.ServiceName
	}
	return ""
...
var file_config_v1_config_proto_goTypes = []any{
	...
	(*ListConfigTemplatesRequest)(nil),  // 19: vn.dsai.config.v1.ListConfigTemplatesRequest
	(*ListConfigTemplatesResponse)(nil), // 20: vn.dsai.config.v1.ListConfigTemplatesResponse
...
var file_config_v1_config_proto_depIdxs = []int32{
	...
	21, // 2: vn.dsai.config.v1.ConfigVersion.created_at:type_name -> google.protobuf.Timestamp
	21, // 3: vn.dsai.config.v1.ConfigVersion.updated_at:type_name -> google.protobuf.Timestamp
